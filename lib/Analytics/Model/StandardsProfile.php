...
class StandardsProfile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'cycle' => '\Ebay\Sell\Analytics\Model\Cycle',
     ...
     * Gets cycle
     *
     * @return \Ebay\Sell\Analytics\Model\Cycle|null
     */
     ...
     * Sets cycle
     *
     * @param \Ebay\Sell\Analytics\Model\Cycle|null $cycle cycle
     *
     * @return self
     */
     ...
     * Sets metrics
     *
     * @param \Ebay\Sell\Analytics\Model\Metric[]|null $metrics A list of the metrics upon which a seller's profile is evaluated. Each program's applicable metrics and requirements are listed at eBay Top Rated seller program standards.
     *
     * @return self
     */
     ...
     * Sets program
     *
     * @param string|null $program Indicates the program used to generate the profile data. Values can be PROGRAM_DE, PROGRAM_UK, PROGRAM_US, or PROGRAM_GLOBAL. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/analytics/types/ssp:ProgramEnum'>eBay API documentation</a>
     *
     * @return self
     */
     ...
     *
     * @param string|null $standards_level The overall standards level of the seller, one of TOP_RATED, ABOVE_STANDARD, or BELOW_STANDARD. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/analytics/types/ssp:StandardsLevelEnum'>eBay API documentation</a>
     *
     * @return self
     */
