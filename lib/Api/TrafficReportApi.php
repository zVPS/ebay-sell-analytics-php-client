...
class TrafficReportApi
{
     ...
     * @return \Ebay\Sell\Analytics\Model\Report
     */
     ...
     * @throws \Ebay\Sell\Analytics\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ebay\Sell\Analytics\Model\Report, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTrafficReportWithHttpInfo($dimension = null, $filter = null, $metric = null, $sort = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ebay\Sell\Analytics\Model\Report' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ebay\Sell\Analytics\Model\Report', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Ebay\Sell\Analytics\Model\Report';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ebay\Sell\Analytics\Model\Report',
    ...
    public function getTrafficReportRequest($dimension = null, $filter = null, $metric = null, $sort = null)
    {
        ...
        if (is_array($dimension)) {
            $dimension = ObjectSerializer::serializeCollection($dimension, '', true);
        }
        if ($dimension !== null) {
